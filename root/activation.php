<?php
  if (isset($_GET['id']) && isset($_GET['u']) && isset($_GET['e']) && isset($_GET['p'])) {
    // Connect to database and sanitize incoming $_GET variablles
    ...
    if ($numrows == 0) {
      // Log this potential hack attempt to text file and email details yourself
    ...
    header("location: message.php?msg=missing_GET_variable");
    exit();
  }
